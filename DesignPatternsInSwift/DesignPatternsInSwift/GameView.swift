...
class GameView: UIView {
  ...
  private final func attributedTextForScore(aScore: Int) -> NSAttributedString? {
    ...
    return NSAttributedString(string: "Score: \(aScore)", attributes: [ NSFontAttributeName : UIFont.boldSystemFontOfSize(32), NSForegroundColorAttributeName : aScore < 0 ? UIColor.redColor() : UIColor.blackColor()])
  }
}
